...
const regex = /let prompt = "";[\s\S]*?Return ONLY the JSON, no markdown, no explanation`;\s*\}/;

const cleanBlock = `let prompt = "";
...
console.log('Successfully fixed the entire prompt block bracket structure.');