          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-[#FCFBF8] rounded-xl border border-[#E8E3D5] flex flex-col relative shadow-[0_10px_40px_rgba(0,0,0,0.03)]">
              ...
              <div className="text-center px-8 pt-12 pb-8 border-b border-[#E8E3D5]/60">
                 ...
                 <div className="flex items-center justify-center gap-3">
                    <div className="text-[#999] line-through font-bold text-xl relative top-1">£500</div>
                    <div className="text-[#C89B3C] text-[3.25rem] font-black leading-none tracking-tighter">£300</div>
            ...
            <div className="bg-[#FCFBF8] rounded-xl border border-[#E8E3D5] flex flex-col relative shadow-[0_10px_40px_rgba(0,0,0,0.03)]">
              ...
              <div className="text-center px-8 pt-12 pb-8 border-b border-[#E8E3D5]/60">
                 ...
                 <div className="flex items-center justify-center gap-3">
                    <div className="text-[#999] line-through font-bold text-xl relative top-1">£300</div>
                    <div className="flex items-baseline gap-1"><span className="text-[#C89B3C] text-[3.25rem] font-black leading-none tracking-tighter">£250</span><span className="text-[#111] font-black text-xs uppercase tracking-widest">/ MONTH</span></div>
                    <div className="bg-[#111] text-[#C89B3C] text-[0.55rem] font-black uppercase tracking-widest px-3 py-1.5 rounded-full relative top-1">Special Offer</div>
                 </div>
              </div>
