...
export function HenleyExpensesDashboard() {
  ...
  const handleUnifiedAutoFill = async () => {
    ...
    try {
      const b1 = JSON.stringify({ date: unifiedAutoFillDate, clientId: session?.user?.role === 'admin' ? 'cmpv4dvik0000vdj089wl6zmf' : session?.user?.clientId, is2025: (filter as any).is2025 === true })
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-[#111520] border border-[#1f2947] rounded-2xl p-6 w-full max-w-sm shadow-2xl">
            ...
            <div className="bg-[#161b2c]/80 border border-[#1f2947] rounded-xl p-4 mb-6 space-y-4 max-h-[50vh] overflow-y-auto">
              ...
              <div>
                <div className="flex justify-between items-center text-sm mb-1.5">
                  <span className="text-yellow-400 font-bold">Tasty Bun Only Expenses</span>
              ...
              <div>
                <div className="flex justify-between items-center text-sm mb-1.5">
                  <span className="text-indigo-400 font-bold">Combined Expenses</span>
